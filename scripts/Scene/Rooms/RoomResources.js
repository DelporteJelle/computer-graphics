...
import { CONCRETE_METAL, METAL_PLATES } from "../../../textures";
 ...
 * GEOMETRIES
 */
export const H_WALL = new THREE.BoxGeometry(ROOM_SIZE, ROOM_HEIGHT, WALL_DEPTH);
export const V_WALL = new THREE.BoxGeometry(WALL_DEPTH, ROOM_HEIGHT, ROOM_SIZE);
...
const getTexture = (path, repeatX = 1, repeatY = 1) => {
...
export const WALL_MATERIAL = new THREE.MeshStandardMaterial({
    map: getTexture(CONCRETE_METAL.baseColor), // Base color texture
});

export const FLOOR_MATERIAL_VISUAL = new THREE.MeshStandardMaterial({
    color: 0x666666,
    map: getTexture(METAL_PLATES.baseColor),
